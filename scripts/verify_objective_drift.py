...
def run_case(name, begin_minutes_ago, begin_eta_seconds, current_eta_seconds, expected):
    ...
    print(f"  begin {begin_minutes_ago}m ago, begin_eta={begin_eta_seconds}s, current_eta={current_eta_seconds}s")
